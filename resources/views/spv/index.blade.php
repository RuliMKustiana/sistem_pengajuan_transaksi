...
@section('title', 'Persetujuan SPV')
@section('page_heading', 'Antrean Verifikasi Supervisor')
...
@section('content')
    ...
    <div class="card card-custom border-0 shadow-sm">
        <div class="card-header bg-white pt-4 pb-2 border-bottom-0 px-4">
            <h5 class="fw-bold text-dark mb-1">Daftar Pengajuan Menunggu Persetujuan</h5>
            <p class="small text-muted mb-0">Periksa rincian nota dan lampiran dokumen sebelum mengambil tindakan
                persetujuan.</p>
        </div>
                    ...
                    <tbody class="small">
                        @forelse($submissions as $submission)
                            <tr>
                                ...
                                <td class="pe-4 py-3">
                                    <form action="{{ route('spv.process', $submission->id) }}" method="POST">
                                        @csrf
                                        <div class="mb-2">
